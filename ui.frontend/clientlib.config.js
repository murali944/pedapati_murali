module.exports = {
    ...
    clientLibRoot: "./../ui.apps/src/main/content/jcr_root/apps/jishaan/clientlibs",

    libs: [
        {
            name: "clientlib-dependencies",
            allowProxy: true,
            categories: ["jishaan.dependencies"],
        ...
        },
        {
            name: "clientlib-site",
            allowProxy: true,
            categories: ["jishaan.site"],
            dependencies: ["jishaan.dependencies"],
            serializationFormat: "xml",
            cssProcessor : ["default:none", "min:none"],
            jsProcessor: ["default:none", "min:none"],
            assets: {
